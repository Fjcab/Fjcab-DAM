...
public class Tablet extends Producto {
	...
	protected Tablet(double precio, String modelo, String marca, int memoria, int descuento) {
		super(precio);
		this.modelo = modelo;
		this.marca = marca;
	...
	public String toString() {
		return "Tablet modelo: " + modelo + ", marca: " + marca + ", memoria: " + memoria + "GB, descuento: " + descuento
				+ "%, precio: " + precio + "€.";
	}
