...
public class HiloParesI implements Runnable { //Clase que hereda de la interfaz Runnable.
	...
	protected HiloParesI(String nombre) {
		this.nombre = nombre;
	...
	public void run() {
		...
		System.out.printf("%s Suma de pares %s. Suma: %s%n",nombre,numGenerados,suma);
